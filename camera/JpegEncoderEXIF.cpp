...
exif_buffer *get_exif_buffer(void *params, void *gpsLocation)
{
    ...
    exif_entry_set_string (pEd, EXIF_IFD_0, EXIF_TAG_MAKE, "LG Electronics");
    ...
    sR.numerator = 1000*par->focal_length;
    sR.denominator = 1000;
    exif_entry_set_rational(pEd, EXIF_IFD_EXIF, EXIF_TAG_FOCAL_LENGTH, sR);

    exif_entry_set_short(pEd, EXIF_IFD_EXIF, EXIF_TAG_FLASH, par->flash_info);
    ...
    switch( par->iso ) {
        ...
        case EXIF_ISO_1600:
            ...
            break;
        default:
            exif_entry_set_short(pEd, EXIF_IFD_EXIF, EXIF_TAG_ISO_SPEED_RATINGS, par->iso);
            break;
    };
