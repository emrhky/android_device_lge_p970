...
#define BACK_CAMERA_AUTO_FOCUS_DISTANCES_STR "0.50,1.50,Infinity"
#define BACK_CAMERA_MACRO_FOCUS_DISTANCES_STR "0.10,0.20,Infinity"
#define BACK_CAMERA_INFINITY_FOCUS_DISTANCES_STR "0.50,1.50,Infinity"
#define FRONT_CAMERA_FOCUS_DISTANCES_STR "0.50,1.50,Infinity"
...
const char CameraHardware::supportedPictureSizes_ffc [] = "1600x1200,1280x960,1280x720,640x480,320x240";
const char CameraHardware::supportedPictureSizes_bfc [] = "2592x1944,2560x1920,2048x1536,2240x1344,1600x1200,1280x960,1280x768,1280x720,640x480,521x384,320x240";
const char CameraHardware::supportedPreviewSizes_ffc [] = "640x480,352x288,320x240,176x144";
const char CameraHardware::supportedPreviewSizes_bfc [] = "1280x720,800x480,720x576,720x480,640x480,352x288,320x240,176x144";
...
void CameraHardware::initDefaultParameters(int CameraID)
{
    ...
    if (CameraID == CAMERA_FF) {
        ALOGE("Setting front cam parameters-------------!!!-------------\n");
        ...
        ALOGE("Setting back cam parameters-------------!!!-------------\n");
        p.setPreviewFormat(CameraParameters::PIXEL_FORMAT_YUV420SP);
        p.setPictureSize(PREVIEW_WIDTH, PREVIEW_HEIGHT);
        p.setPictureFormat(CameraParameters::PIXEL_FORMAT_JPEG);
        p.set(CameraParameters::KEY_JPEG_QUALITY, 100);
...
void CameraHardware::CreateExif(unsigned char* pInThumbnailData, int Inthumbsize, unsigned char* pOutExifBuf, int& OutExifSize, int flag)
{
    ...
    strcpy( (char*)&ExifInfo.maker, "LG Electronics");
    strcpy( (char*)&ExifInfo.model, "LG-P970");
